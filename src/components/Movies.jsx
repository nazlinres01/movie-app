...
const Movies = ({ dt }) => {
  const movieId = dt.id; // Make sure you have the movie ID available

  return (
    <Link href={`/movie/${movieId}`} passHref>
      <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl duration-300 cursor-pointer">
